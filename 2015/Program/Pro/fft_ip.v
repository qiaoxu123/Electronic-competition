...
module fft_ip (
	...
	asj_fft_si_sose_so_b_fft_131	asj_fft_si_sose_so_b_fft_131_inst(
		.clk(clk),
		.reset_n(reset_n),
		.inverse(inverse),
	...
	defparam
		asj_fft_si_sose_so_b_fft_131_inst.nps = 2048,
		asj_fft_si_sose_so_b_fft_131_inst.bfp = 1,
		asj_fft_si_sose_so_b_fft_131_inst.nume = 2,
		asj_fft_si_sose_so_b_fft_131_inst.mpr = 12,
		asj_fft_si_sose_so_b_fft_131_inst.twr = 10,
		asj_fft_si_sose_so_b_fft_131_inst.bpr = 16,
		asj_fft_si_sose_so_b_fft_131_inst.bpb = 4,
		asj_fft_si_sose_so_b_fft_131_inst.fpr = 4,
		asj_fft_si_sose_so_b_fft_131_inst.mram = 0,
		asj_fft_si_sose_so_b_fft_131_inst.m512 = 0,
		asj_fft_si_sose_so_b_fft_131_inst.mult_type = 1,
		asj_fft_si_sose_so_b_fft_131_inst.mult_imp = 0,
		asj_fft_si_sose_so_b_fft_131_inst.dsp_arch = 2,
		asj_fft_si_sose_so_b_fft_131_inst.srr = "AUTO_SHIFT_REGISTER_RECOGNITION=OFF",
		asj_fft_si_sose_so_b_fft_131_inst.rfs1 = "fft_ip_1n2048sin.hex",
		asj_fft_si_sose_so_b_fft_131_inst.rfs2 = "fft_ip_2n2048sin.hex",
		asj_fft_si_sose_so_b_fft_131_inst.rfs3 = "fft_ip_3n2048sin.hex",
		asj_fft_si_sose_so_b_fft_131_inst.rfc1 = "fft_ip_1n2048cos.hex",
		asj_fft_si_sose_so_b_fft_131_inst.rfc2 = "fft_ip_2n2048cos.hex",
		asj_fft_si_sose_so_b_fft_131_inst.rfc3 = "fft_ip_3n2048cos.hex";
endmodule
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.FFTModelClass"  active_core="asj_fft_si_sose_so_b_fft_131" >
...
// Retrieval info:      <PRIVATE name = "TWR" value="10"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "NUM_LE" value="1857"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "NUM_M4K" value="24"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "NUM_CALC_CYCLES" value="6271"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "NUM_BLK_THROUGHPUT_CYCLES" value="10368"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "NUM_MEMBITS" value="98304"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "filename" value="fft_ip.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
