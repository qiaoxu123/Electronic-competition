...
#define add_out P8OUT  //8.5到8.0
#define add_dir P8DIR
#define data_out P6OUT //6.7到6.0
#define data_in P6IN
#define data_dir P6DIR
#define ctrl_out P10OUT
#define ctrl_dir P10DIR
#define UDCLK BIT6  //20脚
#define WR BIT5   //21
#define RD BIT4   //22脚
#define FBH BIT3  //模式选择，在29脚
#define SK BIT2  //osk,在30脚
#define SP BIT1  //sp为串并选择，在70脚
#define RST BIT0  //复位，在71脚
...
{                           
  ...
  send_byte(REFCLK,0x47);     //PLL大于200MHz，不旁路PLL，4倍频  dc,pllrange,bypasspll,ref4  ref3,ref2,ref1,ref0             
  ...
  send_byte(OSK_S,0x60);     //旁路Inv Sinc，使能OSK EN
...
void ad9854v(float v) 
{
  ...
  {
    table9854[6]=((uint)(v*4096/5))/256;//高位
    table9854[7]=((uint)(v*4096/5))%256;//用原来的数取余256
  }
