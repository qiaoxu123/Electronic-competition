...
SOPCINFO_FILE := E:/DE1-SOC/class10-Digital_Freq/cpu.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x80010e8
SOPC_SYSID_FLAG += --sidp=0x80010e8
ELF_PATCH_FLAG  += --sidp 0x80010e8

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1498619909
SOPC_SYSID_FLAG += --timestamp=1498619909
ELF_PATCH_FLAG  += --timestamp 1498619909
